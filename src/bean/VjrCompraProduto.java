 ...
 * @author u09208248119
 */
public class VjrCompraProduto {

    /**
     * @return the VjrIdCodigo
     */
    public int getVjrIdCodigo() {
        return VjrIdCodigo;
    }

    /**
     * @param VjrIdCodigo the VjrIdCodigo to set
     */
    public void setVjrIdCodigo(int VjrIdCodigo) {
        this.VjrIdCodigo = VjrIdCodigo;
    }
